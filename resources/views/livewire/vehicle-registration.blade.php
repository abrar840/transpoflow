<section class="content">
    ...
    <main>
        ...
        <div class="vehicle-box-info ">
            ...
            <div id="registrationForm" class="registration-card vehicle-management-container" @if($showForm)
                ...
                <form wire:submit.prevent="registerVehicle" class="registration-form">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="registration_number" id="registration_number"
                                ...
                                @if($editingVehicleId)@disabled(true)@endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="seating_capacity" id="seating_capacity" class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="year" id="year" class="form-input" min="1900"
                                max="{{ date('Y') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="make" id="make" class="form-input" placeholder="e.g., Toyota"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="model" id="model" class="form-input"
                                placeholder="e.g., Hiace" required>
                        ...
                        <div class="form-group span-2">
                            ...
                            <textarea wire:model="notes" id="notes" class="form-input" rows="3"></textarea>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="submit-btn">
                            <span wire:loading.remove>{{ $editingVehicleId ? 'Update Vehicle' : 'Register Vehicle'
                                }}</span>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <button id=edit wire:click="editVehicle('{{ $vehicle->registration_number }}')"
                                        class="edit-btn">
                                        Edit
                                    </button>
